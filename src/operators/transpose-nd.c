    ...
    xnn_operator_t* space_to_depth_op_out)
{
  ...
  if (output_channel_stride < output_channels) {
    xnn_log_error(
      ...
      xnn_operator_type_to_string(operator_type),
      output_channel_stride, block_size, block_size, output_channels);
    goto error;
  }
    ...
    uint32_t element_size)
{
  ...
  const size_t input_shape[5] = {batch_size * input_height, block_size, input_width, block_size, space_to_depth_op->channels};
  //const size_t output_shape[5] = {batch_size * input_height, input_width, block_size, block_size, space_to_depth_op->channels};
  const size_t perm[5] = {0, 2, 1, 3, 4};
  //const size_t input_stride[5] = {
  //  block_size * input_width * block_size * space_to_depth_op->input_pixel_stride,
  //  input_width * block_size * space_to_depth_op->input_pixel_stride,
  //  block_size * space_to_depth_op->input_pixel_stride,
  //  space_to_depth_op->input_pixel_stride,
  //  1};
  //const size_t input_stride[5] = {
  //  block_size * input_width * block_size * space_to_depth_op->channels,
  //  input_width * block_size * space_to_depth_op->channels,
  //  block_size * space_to_depth_op->channels,
  //  space_to_depth_op->channels,
  //  1};
  //const size_t output_stride[5] = {
  //  input_width * space_to_depth_op->output_pixel_stride,
 ...
 //   1};
  //const size_t output_stride[5] = {
  //  block_size * input_width * block_size * space_to_depth_op->output_pixel_stride,
  //  input_width * block_size * space_to_depth_op->output_pixel_stride,
  //  block_size * space_to_depth_op->output_pixel_stride,
  //  space_to_depth_op->output_pixel_stride,
  //  1};
  ...
  return setup_transpose(
      ...
      input_shape,
      perm,
      NULL, NULL,//output_stride,
      //((space_to_depth_op->input_pixel_stride == space_to_depth_op->channels) ? NULL : input_stride),
      //((space_to_depth_op->output_pixel_stride == block_size * block_size * space_to_depth_op->channels) ? NULL : output_stride),
      element_size);
}
